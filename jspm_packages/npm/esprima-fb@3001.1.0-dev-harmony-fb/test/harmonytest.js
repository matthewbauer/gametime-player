...
(function(process) {
  ...
  var harmonyTestFixture = {
    ...
    'ES6: Switch Case Declaration': {'switch (answer) { case 42: let t = 42; break; }': {
    ...
    'Harmony: Object Literal Property Value Shorthand': {'x = { y, z }': {
        type: 'ExpressionStatement',
        expression: {
          type: 'AssignmentExpression',
          operator: '=',
    ...
    'ES6: Rest parameters': {'function f(a, ...b) {}': {
        type: 'FunctionDeclaration',
        id: {
          type: 'Identifier',
          name: 'f',
